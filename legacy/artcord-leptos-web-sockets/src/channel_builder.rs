...
use crate::{
    channel::{WsChannelHandle, WsChannelsType, WsRecvResult, WsResourcSendResult},
...
> {
    ...
    prop_unique_key: bool,
    prop_override_channel: bool,
    prop_cleanup: bool,
    ...
    ChannelBuilder<ServerMsg, ClientMsg>
{
    pub fn new(
        ...
        Self {
            ...
            prop_unique_key: false,
            prop_override_channel: true,
            prop_cleanup: true,
    ...
    // pub fn detach(mut self, state: bool) -> Self {
    //     self.prop_detach = state;
    //     self
    // }
    ...
    pub fn override_channel(mut self, state: bool) -> Self {
        self.prop_override_channel = state;
        self
    }

    pub fn override_cleanup(mut self, state: bool) -> Self {
        self.prop_cleanup = state;
        self
    }

    pub fn override_unique_key(mut self, state: bool) -> Self {
        self.prop_unique_key = state;
        self
    }

    pub fn single_fire(mut self, state: bool) -> Self {
        self.prop_single_fire = state;
        self
    }

    // #[track_caller]
    // pub fn start(self) -> ChannelInterface<ServerMsg, ClientMsg> {
    //     let channel = WsChannelHandle::new(
    //         self.ws_url,
    //         self.channels,
    //         self.ws,
    ...
    //         self.prop_timeout,
    //         self.prop_unique_key,
    //         self.prop_override_channel,
    //         self.prop_cleanup,   
...
> {
    channel: WsChannelHandle<ServerMsg, ClientMsg>,
}
...
{
    pub fn new(channel: WsChannelHandle<ServerMsg, ClientMsg>) -> Self {
        Self { channel }
    }
